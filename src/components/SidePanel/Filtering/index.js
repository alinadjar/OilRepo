...
import { toggleFilteringSidePanel } from '../../../iRedux/Actions/common';
...
class FilterPanel extends Component {
    ...
    componentDidMount() {
        //this.props.toggleFilteringSidePanel();
    }
    ...
    toggleSidePanel = () => {
        ...
        if (!sidePanel.classList.contains('isOpen')) {
            this.setState({ showPanel: !this.state.showPanel }, () => this.props.toggleFilteringSidePanel());
        }
    }
...
const mapStateToProps = (state) => ({
    showPanelState: state.common.showPanelFiltering,
})
